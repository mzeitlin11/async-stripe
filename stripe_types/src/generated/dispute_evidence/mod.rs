...
pub struct DisputeEvidence {
    ...
    pub cancellation_policy: Option<stripe_types::Expandable<stripe_types::File>>,
    ...
    pub customer_communication: Option<stripe_types::Expandable<stripe_types::File>>,
    ...
    pub customer_signature: Option<stripe_types::Expandable<stripe_types::File>>,
    ...
    pub duplicate_charge_documentation: Option<stripe_types::Expandable<stripe_types::File>>,
    ...
    pub receipt: Option<stripe_types::Expandable<stripe_types::File>>,
    /// (ID of a [file upload](https://stripe.com/docs/guides/file-upload)) Your refund policy, as shown to the customer.
    pub refund_policy: Option<stripe_types::Expandable<stripe_types::File>>,
    ...
    pub service_documentation: Option<stripe_types::Expandable<stripe_types::File>>,
    ...
    pub shipping_documentation: Option<stripe_types::Expandable<stripe_types::File>>,
    /// The tracking number for a physical product, obtained from the delivery service.
    ///
    /// If multiple tracking numbers were generated for this purchase, please separate them with commas.
    pub shipping_tracking_number: Option<String>,
    /// (ID of a [file upload](https://stripe.com/docs/guides/file-upload)) Any additional evidence or statements.
    pub uncategorized_file: Option<stripe_types::Expandable<stripe_types::File>>,
