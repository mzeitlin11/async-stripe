...
pub struct PaymentIntentPaymentMethodOptionsUsBankAccountBuilder {
    ...
    preferred_settlement_speed: Option<Option<PaymentIntentPaymentMethodOptionsUsBankAccountPreferredSettlementSpeed>>,
    setup_future_usage: Option<Option<PaymentIntentPaymentMethodOptionsUsBankAccountSetupFutureUsage>>,
    verification_method: Option<Option<PaymentIntentPaymentMethodOptionsUsBankAccountVerificationMethod>>,
}
...
const _: () = {
    ...
    impl Visitor for Place<PaymentIntentPaymentMethodOptionsUsBankAccount> {
        fn map(&mut self) -> Result<Box<dyn Map + '_>> {
            Ok(Box::new(Builder { out: &mut self.out, builder: PaymentIntentPaymentMethodOptionsUsBankAccountBuilder::deser_default() }))
        }
    }
    ...
    impl MapBuilder for PaymentIntentPaymentMethodOptionsUsBankAccountBuilder {
        ...
        fn key(&mut self, k: &str) -> miniserde::Result<&mut dyn Visitor> {
            match k {
                ...
                "preferred_settlement_speed" => Ok(Deserialize::begin(&mut self.preferred_settlement_speed)),
        ...
        fn take_out(&mut self) -> Option<Self::Out> {
            ...
            let preferred_settlement_speed = self.preferred_settlement_speed.take()?;
            let setup_future_usage = self.setup_future_usage.take()?;
            let verification_method = self.verification_method.take()?;

            Some(Self::Out { financial_connections, preferred_settlement_speed, setup_future_usage, verification_method })
        }
    }
...
impl<'de> serde::Deserialize<'de> for PaymentIntentPaymentMethodOptionsUsBankAccountPreferredSettlementSpeed {
...
#[cfg(feature = "min-ser")]
impl miniserde::Deserialize for PaymentIntentPaymentMethodOptionsUsBankAccountPreferredSettlementSpeed {
...
#[cfg(feature = "min-ser")]
impl miniserde::de::Visitor for crate::Place<PaymentIntentPaymentMethodOptionsUsBankAccountPreferredSettlementSpeed> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(PaymentIntentPaymentMethodOptionsUsBankAccountPreferredSettlementSpeed::from_str(s).map_err(|_| miniserde::Error)?);
        Ok(())
    }
}
/// Indicates that you intend to make future payments with this PaymentIntent's payment method.
...
#[cfg(feature = "min-ser")]
impl miniserde::de::Visitor for crate::Place<PaymentIntentPaymentMethodOptionsUsBankAccountSetupFutureUsage> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(PaymentIntentPaymentMethodOptionsUsBankAccountSetupFutureUsage::from_str(s).map_err(|_| miniserde::Error)?);
        Ok(())
    }
}
/// Bank account verification method.
...
#[cfg(feature = "min-ser")]
impl miniserde::de::Visitor for crate::Place<PaymentIntentPaymentMethodOptionsUsBankAccountVerificationMethod> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(PaymentIntentPaymentMethodOptionsUsBankAccountVerificationMethod::from_str(s).map_err(|_| miniserde::Error)?);
        Ok(())
    }
}
