...
pub struct IssuingDisputeEvidence {
    ...
    pub canceled: Option<stripe_types::IssuingDisputeCanceledEvidence>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub duplicate: Option<stripe_types::IssuingDisputeDuplicateEvidence>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub other: Option<stripe_types::IssuingDisputeOtherEvidence>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub service_not_as_described: Option<stripe_types::IssuingDisputeServiceNotAsDescribedEvidence>,
}
/// The reason for filing the dispute.
///
/// Its value will match the field containing the evidence.
