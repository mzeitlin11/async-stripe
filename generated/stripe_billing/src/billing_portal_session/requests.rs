...
#[derive(Copy, Clone, Eq, PartialEq)]
#[non_exhaustive]
pub enum CreateBillingPortalSessionLocale {
    Auto,
    Bg,
    Cs,
    Da,
...
impl CreateBillingPortalSessionLocale {
    pub fn as_str(self) -> &'static str {
        use CreateBillingPortalSessionLocale::*;
        match self {
            Auto => "auto",
            Bg => "bg",
            Cs => "cs",
...
impl std::str::FromStr for CreateBillingPortalSessionLocale {
    type Err = ();
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        use CreateBillingPortalSessionLocale::*;
        match s {
...
impl AsRef<str> for CreateBillingPortalSessionLocale {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
impl std::fmt::Display for CreateBillingPortalSessionLocale {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}

impl std::fmt::Debug for CreateBillingPortalSessionLocale {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}
impl serde::Serialize for CreateBillingPortalSessionLocale {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
