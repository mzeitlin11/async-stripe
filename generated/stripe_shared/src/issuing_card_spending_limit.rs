...
pub struct IssuingCardSpendingLimitBuilder {
    amount: Option<i64>,
    categories: Option<Option<Vec<IssuingCardSpendingLimitCategories>>>,
...
const _: () = {
    ...
    impl Deserialize for IssuingCardSpendingLimit {
    ...
    struct Builder<'a> {
        out: &'a mut Option<IssuingCardSpendingLimit>,
        builder: IssuingCardSpendingLimitBuilder,
    }

    impl Visitor for Place<IssuingCardSpendingLimit> {
        fn map(&mut self) -> Result<Box<dyn Map + '_>> {
            Ok(Box::new(Builder { out: &mut self.out, builder: IssuingCardSpendingLimitBuilder::deser_default() }))
        }
    }

    impl MapBuilder for IssuingCardSpendingLimitBuilder {
        type Out = IssuingCardSpendingLimit;
        fn key(&mut self, k: &str) -> miniserde::Result<&mut dyn Visitor> {
            match k {
                "amount" => Ok(Deserialize::begin(&mut self.amount)),
                "categories" => Ok(Deserialize::begin(&mut self.categories)),
        ...
        fn deser_default() -> Self {
            Self { amount: Deserialize::default(), categories: Deserialize::default(), interval: Deserialize::default() }
        }
    ...
    impl ObjectDeser for IssuingCardSpendingLimit {
        type Builder = IssuingCardSpendingLimitBuilder;
    }
};
/// Array of strings containing [categories](https://stripe.com/docs/api#issuing_authorization_object-merchant_data-category) this limit applies to.
/// Omitting this field will apply the limit to all categories.
...
#[cfg(feature = "min-ser")]
impl miniserde::Deserialize for IssuingCardSpendingLimitCategories {
...
impl miniserde::de::Visitor for crate::Place<IssuingCardSpendingLimitCategories> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(IssuingCardSpendingLimitCategories::from_str(s).unwrap_or(IssuingCardSpendingLimitCategories::Unknown));
        Ok(())
    }
}
/// Interval (or event) to which the amount applies.
...
impl<'de> serde::Deserialize<'de> for IssuingCardSpendingLimitInterval {
    fn deserialize<D: serde::Deserializer<'de>>(deserializer: D) -> Result<Self, D::Error> {
        use std::str::FromStr;
        let s: std::borrow::Cow<'de, str> = serde::Deserialize::deserialize(deserializer)?;
        Self::from_str(&s).map_err(|_| serde::de::Error::custom("Unknown value for IssuingCardSpendingLimitInterval"))
    }
}
#[cfg(feature = "min-ser")]
impl miniserde::Deserialize for IssuingCardSpendingLimitInterval {
    fn begin(out: &mut Option<Self>) -> &mut dyn miniserde::de::Visitor {
        crate::Place::new(out)
    }
}
...
#[cfg(feature = "min-ser")]
impl miniserde::de::Visitor for crate::Place<IssuingCardSpendingLimitInterval> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(IssuingCardSpendingLimitInterval::from_str(s).map_err(|_| miniserde::Error)?);
        Ok(())
    }
}
