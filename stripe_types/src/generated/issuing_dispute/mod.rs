...
pub struct IssuingDispute {
    ...
    pub balance_transactions: Option<Vec<stripe_types::BalanceTransaction>>,
    ...
    pub evidence: stripe_types::IssuingDisputeEvidence,
    /// Unique identifier for the object.
    pub id: stripe_types::issuing_dispute::IssuingDisputeId,
    ...
    pub transaction: stripe_types::Expandable<stripe_types::IssuingTransaction>,
    /// [Treasury](https://stripe.com/docs/api/treasury) details related to this dispute if it was created on a [FinancialAccount](/docs/api/treasury/financial_accounts.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub treasury: Option<stripe_types::IssuingDisputeTreasury>,
}
/// Current status of the dispute.
...
impl stripe_types::Object for IssuingDispute {
    type Id = stripe_types::issuing_dispute::IssuingDisputeId;
