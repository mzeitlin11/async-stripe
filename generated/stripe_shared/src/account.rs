    ...
    impl MapBuilder for AccountBuilder {
        ...
        fn key(&mut self, k: &str) -> miniserde::Result<&mut dyn Visitor> {
            ...
            match k {
                ...
                "business_type" => Ok(Deserialize::begin(&mut self.business_type)),
                "capabilities" => Ok(Deserialize::begin(&mut self.capabilities)),
                "charges_enabled" => Ok(Deserialize::begin(&mut self.charges_enabled)),
                "company" => Ok(Deserialize::begin(&mut self.company)),
                "controller" => Ok(Deserialize::begin(&mut self.controller)),
                "country" => Ok(Deserialize::begin(&mut self.country)),
                "created" => Ok(Deserialize::begin(&mut self.created)),
                "default_currency" => Ok(Deserialize::begin(&mut self.default_currency)),
                "details_submitted" => Ok(Deserialize::begin(&mut self.details_submitted)),
                "email" => Ok(Deserialize::begin(&mut self.email)),
                "external_accounts" => Ok(Deserialize::begin(&mut self.external_accounts)),
                ...
                "payouts_enabled" => Ok(Deserialize::begin(&mut self.payouts_enabled)),
