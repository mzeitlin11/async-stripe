...
impl AsRef<str> for CreateTreasuryOutboundPaymentDestinationPaymentMethodDataType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl<'a> RetrieveTreasuryOutboundPayment<'a> {
    ...
    pub fn send(&self, client: &stripe::Client, id: &stripe_treasury::treasury_outbound_payment::TreasuryOutboundPaymentId) -> stripe::Response<stripe_treasury::TreasuryOutboundPayment> {
...
pub struct ListTreasuryOutboundPayment<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<ListTreasuryOutboundPaymentStatus>,
}
...
/// Only return OutboundPayments that have the given status: `processing`, `failed`, `posted`, `returned`, or `canceled`.
#[derive(Copy, Clone, Eq, PartialEq)]
pub enum ListTreasuryOutboundPaymentStatus {
    Canceled,
    Failed,
    Posted,
    Processing,
...
impl ListTreasuryOutboundPaymentStatus {
    pub fn as_str(self) -> &'static str {
        use ListTreasuryOutboundPaymentStatus::*;
        match self {
            Canceled => "canceled",
            Failed => "failed",
            Posted => "posted",
...
impl std::str::FromStr for ListTreasuryOutboundPaymentStatus {
    type Err = ();
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        use ListTreasuryOutboundPaymentStatus::*;
        match s {
...
impl AsRef<str> for ListTreasuryOutboundPaymentStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
impl std::fmt::Display for ListTreasuryOutboundPaymentStatus {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}

impl std::fmt::Debug for ListTreasuryOutboundPaymentStatus {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}
impl serde::Serialize for ListTreasuryOutboundPaymentStatus {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
impl AsRef<str> for ReturnOutboundPaymentTreasuryOutboundPaymentReturnedDetailsCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
