...
impl<'a> ListIssuingTransaction<'a> {
    ...
    pub fn send(&self, client: &stripe::Client) -> stripe::Response<stripe_types::List<stripe_shared::IssuingTransaction>> {
        client.get_query("/issuing/transactions", self)
    }
    pub fn paginate(self) -> stripe::ListPaginator<stripe_types::List<stripe_shared::IssuingTransaction>> {
...
impl<'a> RetrieveIssuingTransaction<'a> {
    ...
    pub fn send(&self, client: &stripe::Client, transaction: &stripe_shared::IssuingTransactionId) -> stripe::Response<stripe_shared::IssuingTransaction> {
...
impl<'a> UpdateIssuingTransaction<'a> {
    ...
    pub fn send(&self, client: &stripe::Client, transaction: &stripe_shared::IssuingTransactionId) -> stripe::Response<stripe_shared::IssuingTransaction> {
        client.send_form(&format!("/issuing/transactions/{transaction}"), self, http_types::Method::Post)
    }
}
...
impl<'a> CreateForceCaptureIssuingTransaction<'a> {
    pub fn new(amount: i64, card: &'a str) -> Self {
        Self { amount, card, currency: None, expand: None, merchant_data: None, purchase_details: None }
    }
}
/// Details about the seller (grocery store, e-commerce website, etc.) where the card authorization happened.
#[derive(Copy, Clone, Debug, Default, serde::Serialize)]
...
impl<'a> CreateForceCaptureIssuingTransaction<'a> {
    ...
    pub fn send(&self, client: &stripe::Client) -> stripe::Response<stripe_shared::IssuingTransaction> {
        client.send_form("/test_helpers/issuing/transactions/create_force_capture", self, http_types::Method::Post)
    }
}
#[derive(Copy, Clone, Debug, serde::Serialize)]
...
impl<'a> CreateUnlinkedRefundIssuingTransaction<'a> {
    ...
    pub fn send(&self, client: &stripe::Client) -> stripe::Response<stripe_shared::IssuingTransaction> {
        client.send_form("/test_helpers/issuing/transactions/create_unlinked_refund", self, http_types::Method::Post)
    }
}
#[derive(Copy, Clone, Debug, Default, serde::Serialize)]
...
impl<'a> RefundIssuingTransaction<'a> {
    ...
    pub fn send(&self, client: &stripe::Client, transaction: &str) -> stripe::Response<stripe_shared::IssuingTransaction> {
        client.send_form(&format!("/test_helpers/issuing/transactions/{transaction}/refund"), self, http_types::Method::Post)
    }
}
#[derive(Copy, Clone, Debug, Default, serde::Serialize)]
