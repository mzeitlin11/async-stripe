...
impl AsRef<str> for ListTreasuryReceivedCreditLinkedFlowsSourceFlowType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl<'a> ListTreasuryReceivedCredit<'a> {
    ...
    pub fn paginate(self) -> stripe::ListPaginator<stripe_treasury::TreasuryReceivedCredit> {
        stripe::ListPaginator::from_params("/treasury/received_credits", self)
    }
}
impl<'a> stripe::PaginationParams for ListTreasuryReceivedCredit<'a> {}
...
impl<'a> RetrieveTreasuryReceivedCredit<'a> {
    ...
    pub fn send(&self, client: &stripe::Client, id: &stripe_treasury::treasury_received_credit::TreasuryReceivedCreditId) -> stripe::Response<stripe_treasury::TreasuryReceivedCredit> {
...
impl AsRef<str> for CreateTreasuryReceivedCreditInitiatingPaymentMethodDetailsType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl AsRef<str> for CreateTreasuryReceivedCreditNetwork {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
