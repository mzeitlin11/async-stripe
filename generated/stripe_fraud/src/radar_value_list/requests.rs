...
impl<'a> ListRadarValueList<'a> {
    ...
    pub fn paginate(self) -> stripe::ListPaginator<stripe_fraud::RadarValueList> {
        stripe::ListPaginator::from_params("/radar/value_lists", self)
    }
}
impl<'a> stripe::PaginationParams for ListRadarValueList<'a> {}
#[derive(Copy, Clone, Debug, Default, serde::Serialize)]
...
pub enum CreateRadarValueListItemType {
    CardBin,
    CardFingerprint,
    CaseSensitiveString,
    Country,
...
impl CreateRadarValueListItemType {
    pub fn as_str(self) -> &'static str {
        use CreateRadarValueListItemType::*;
        match self {
            CardBin => "card_bin",
...
impl std::str::FromStr for CreateRadarValueListItemType {
    type Err = ();
...
impl AsRef<str> for CreateRadarValueListItemType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
impl std::fmt::Display for CreateRadarValueListItemType {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}

impl std::fmt::Debug for CreateRadarValueListItemType {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}
impl serde::Serialize for CreateRadarValueListItemType {
