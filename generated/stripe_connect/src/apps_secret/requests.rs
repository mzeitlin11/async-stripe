...
impl AsRef<str> for FindAppsSecretScopeType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl AsRef<str> for CreateAppsSecretScopeType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl AsRef<str> for DeleteWhereAppsSecretScopeType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl AsRef<str> for ListAppsSecretScopeType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
