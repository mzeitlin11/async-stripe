...
/// Coupons do not work with conventional one-off [charges](https://stripe.com/docs/api#create_charge) or [payment intents](https://stripe.com/docs/api/payment_intents).  For more details see <<https://stripe.com/docs/api/coupons/object>>.
...
pub struct Coupon {
    ...
    pub id: stripe_shared::coupon::CouponId,
...
impl stripe_types::Object for Coupon {
    type Id = stripe_shared::coupon::CouponId;
    fn id(&self) -> &Self::Id {
        &self.id
    }
}
