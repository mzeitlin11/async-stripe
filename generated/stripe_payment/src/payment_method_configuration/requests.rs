...
impl<'a> RetrievePaymentMethodConfiguration<'a> {
    ...
    pub fn send(
        &self,
        client: &stripe::Client,
        configuration: &stripe_payment::payment_method_configuration::PaymentMethodConfigurationId,
...
impl AsRef<str> for UpdatePaymentMethodConfigurationCardDisplayPreferencePreference {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl AsRef<str> for CreatePaymentMethodConfigurationCardDisplayPreferencePreference {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
