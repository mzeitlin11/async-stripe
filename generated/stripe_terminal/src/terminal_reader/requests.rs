...
pub struct ListTerminalReader<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<ListTerminalReaderStatus>,
}
...
pub enum ListTerminalReaderStatus {
    Offline,
    Online,
}
impl ListTerminalReaderStatus {
    pub fn as_str(self) -> &'static str {
        use ListTerminalReaderStatus::*;
        match self {
            Offline => "offline",
            Online => "online",
        }
...
impl std::str::FromStr for ListTerminalReaderStatus {
    type Err = ();
...
impl AsRef<str> for ListTerminalReaderStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
impl std::fmt::Display for ListTerminalReaderStatus {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}

impl std::fmt::Debug for ListTerminalReaderStatus {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}
impl serde::Serialize for ListTerminalReaderStatus {
...
impl AsRef<str> for SetReaderDisplayTerminalReaderType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl AsRef<str> for PresentPaymentMethodTerminalReaderType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
