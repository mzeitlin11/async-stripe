...
const _: () = {
    ...
    impl Visitor for Place<PaymentLinksResourceShippingAddressCollection> {
        fn map(&mut self) -> Result<Box<dyn Map + '_>> {
            Ok(Box::new(Builder { out: &mut self.out, builder: PaymentLinksResourceShippingAddressCollectionBuilder::deser_default() }))
        }
    }
...
#[cfg(feature = "min-ser")]
impl miniserde::de::Visitor for crate::Place<PaymentLinksResourceShippingAddressCollectionAllowedCountries> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(PaymentLinksResourceShippingAddressCollectionAllowedCountries::from_str(s).unwrap_or(PaymentLinksResourceShippingAddressCollectionAllowedCountries::Unknown));
        Ok(())
    }
}
