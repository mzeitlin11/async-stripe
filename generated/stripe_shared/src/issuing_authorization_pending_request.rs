...
const _: () = {
    ...
    impl Visitor for Place<IssuingAuthorizationPendingRequest> {
        fn map(&mut self) -> Result<Box<dyn Map + '_>> {
            Ok(Box::new(Builder { out: &mut self.out, builder: IssuingAuthorizationPendingRequestBuilder::deser_default() }))
        }
    }
    ...
    impl MapBuilder for IssuingAuthorizationPendingRequestBuilder {
        ...
        fn key(&mut self, k: &str) -> miniserde::Result<&mut dyn Visitor> {
            ...
            match k {
                ...
                "is_amount_controllable" => Ok(Deserialize::begin(&mut self.is_amount_controllable)),
        ...
        fn take_out(&mut self) -> Option<Self::Out> {
            ...
            let is_amount_controllable = self.is_amount_controllable.take()?;
            ...
            Some(Self::Out { amount, amount_details, currency, is_amount_controllable, merchant_amount, merchant_currency, network_risk_score })
        }
    }
