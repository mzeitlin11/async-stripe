...
impl<'a> CancelTreasuryInboundTransfer<'a> {
    ...
    pub fn send(&self, client: &stripe::Client, inbound_transfer: &stripe_treasury::treasury_inbound_transfer::TreasuryInboundTransferId) -> stripe::Response<stripe_treasury::TreasuryInboundTransfer> {
...
impl<'a> CreateTreasuryInboundTransfer<'a> {
    ...
    pub fn send(&self, client: &stripe::Client) -> stripe::Response<stripe_treasury::TreasuryInboundTransfer> {
...
impl<'a> RetrieveTreasuryInboundTransfer<'a> {
    ...
    pub fn send(&self, client: &stripe::Client, id: &stripe_treasury::treasury_inbound_transfer::TreasuryInboundTransferId) -> stripe::Response<stripe_treasury::TreasuryInboundTransfer> {
...
pub struct ListTreasuryInboundTransfer<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub status: Option<ListTreasuryInboundTransferStatus>,
}
...
pub enum ListTreasuryInboundTransferStatus {
    Canceled,
    Failed,
    Processing,
    Succeeded,
}
impl ListTreasuryInboundTransferStatus {
    pub fn as_str(self) -> &'static str {
        use ListTreasuryInboundTransferStatus::*;
        match self {
            Canceled => "canceled",
            Failed => "failed",
...
impl std::str::FromStr for ListTreasuryInboundTransferStatus {
    type Err = ();
...
impl AsRef<str> for ListTreasuryInboundTransferStatus {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
impl std::fmt::Display for ListTreasuryInboundTransferStatus {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}

impl std::fmt::Debug for ListTreasuryInboundTransferStatus {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}
impl serde::Serialize for ListTreasuryInboundTransferStatus {
...
impl<'a> ListTreasuryInboundTransfer<'a> {
    ...
    pub fn send(&self, client: &stripe::Client) -> stripe::Response<stripe_types::List<stripe_treasury::TreasuryInboundTransfer>> {
...
impl<'a> SucceedTreasuryInboundTransfer<'a> {
    ...
    pub fn send(&self, client: &stripe::Client, id: &str) -> stripe::Response<stripe_treasury::TreasuryInboundTransfer> {
...
impl AsRef<str> for FailTreasuryInboundTransferFailureDetailsCode {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
