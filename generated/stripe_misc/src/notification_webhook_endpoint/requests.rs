...
pub struct CreateNotificationWebhookEndpoint<'a> {
    ...
    pub enabled_events: &'a [CreateNotificationWebhookEndpointEnabledEvents],
    /// Specifies which fields in the response should be expanded.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub expand: Option<&'a [&'a str]>,
...
#[non_exhaustive]
pub enum CreateNotificationWebhookEndpointEnabledEvents {
    All,
...
impl CreateNotificationWebhookEndpointEnabledEvents {
    pub fn as_str(self) -> &'static str {
        use CreateNotificationWebhookEndpointEnabledEvents::*;
        match self {
            All => "*",
...
impl std::str::FromStr for CreateNotificationWebhookEndpointEnabledEvents {
    type Err = ();
...
impl AsRef<str> for CreateNotificationWebhookEndpointEnabledEvents {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
impl std::fmt::Display for CreateNotificationWebhookEndpointEnabledEvents {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}

impl std::fmt::Debug for CreateNotificationWebhookEndpointEnabledEvents {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}
impl serde::Serialize for CreateNotificationWebhookEndpointEnabledEvents {
...
#[derive(Copy, Clone, Debug, Default, serde::Serialize)]
pub struct UpdateNotificationWebhookEndpoint<'a> {
    /// An optional description of what the webhook is used for.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub description: Option<&'a str>,
    ...
    /// You may specify `['*']` to enable all events, except those that require explicit selection.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub enabled_events: Option<&'a [UpdateNotificationWebhookEndpointEnabledEvents]>,
    /// Specifies which fields in the response should be expanded.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub expand: Option<&'a [&'a str]>,
    /// Set of [key-value pairs](https://stripe.com/docs/api/metadata) that you can attach to an object.
...
#[derive(Copy, Clone, Eq, PartialEq)]
#[non_exhaustive]
pub enum UpdateNotificationWebhookEndpointEnabledEvents {
    All,
    AccountApplicationAuthorized,
    AccountApplicationDeauthorized,
    AccountExternalAccountCreated,
...
impl UpdateNotificationWebhookEndpointEnabledEvents {
    pub fn as_str(self) -> &'static str {
        use UpdateNotificationWebhookEndpointEnabledEvents::*;
        match self {
            All => "*",
            AccountApplicationAuthorized => "account.application.authorized",
            AccountApplicationDeauthorized => "account.application.deauthorized",
...
impl std::str::FromStr for UpdateNotificationWebhookEndpointEnabledEvents {
    type Err = ();
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        use UpdateNotificationWebhookEndpointEnabledEvents::*;
        match s {
...
impl AsRef<str> for UpdateNotificationWebhookEndpointEnabledEvents {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
impl std::fmt::Display for UpdateNotificationWebhookEndpointEnabledEvents {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}

impl std::fmt::Debug for UpdateNotificationWebhookEndpointEnabledEvents {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}
impl serde::Serialize for UpdateNotificationWebhookEndpointEnabledEvents {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
