...
pub fn crate_mappings() -> ObjectMap {
    [
        ("account", "connect"),
        ("account_link", "connect"),
        ("alipay_account", "payment"),
        ("apple_pay_domain", "core"),
        ("application", "connect"),
        ("application_fee", "connect"),
        ("balance", "core"),
        ("balance_transaction", "core"),
        ("bank_account", "payment"),
        ("billing_portal.configuration", "billing"),
        ("billing_portal.session", "billing"),
        ("bitcoin_receiver", "core"),
        ("bitcoin_transaction", "core"),
        ("capability", "core"),
        ("card", "payment"),
        ("charge", "core"),
        ...
        ("file", "core"),
        ("file_link", "core"),
        ("identity.verification_report", "core"),
        ("identity.verification_session", "core"),
        ("invoice", "billing"),
        ("invoiceitem", "billing"),
        ("issuer_fraud_record", "core"),
        ("issuing.authorization", "issuing"),
        ("issuing.card", "issuing"),
        ("issuing.cardholder", "issuing"),
        ("issuing.dispute", "issuing"),
        ("issuing.settlement", "issuing"),
        ("issuing.transaction", "issuing"),
        ("item", "core"),
        ("line_item", "billing"),
        ("login_link", "connect"),
        ("mandate", "core"),
        ("notification_event_data", "core"),
        ("order", "orders"),
        ("order_item", "orders"),
        ("order_return", "orders"),
        ("payment_intent", "core"),
        ...
        ("quote", "billing"),
        ("radar.early_fraud_warning", "core"),
        ("radar.value_list", "core"),
        ("radar.value_list_item", "core"),
        ("recipient", "connect"),
        ("refund", "core"),
        ("reporting.report_run", "core"),
        ("reporting.report_type", "core"),
        ...
        ("tax_code", "core"),
        ("tax_deducted_at_source", "core"),
        ("tax_id", "billing"),
        ("tax_rate", "billing"),
        ("terminal.connection_token", "core"),
        ("terminal.location", "core"),
        ("terminal.reader", "core"),
        ("test_helpers.test_clock", "core"),
        ("three_d_secure", "core"),
        ("token", "core"),
        ("topup", "connect"),
        ("transfer", "connect"),
