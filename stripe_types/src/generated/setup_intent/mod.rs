...
pub struct SetupIntent {
    ...
    pub automatic_payment_methods:
        Option<stripe_types::PaymentFlowsAutomaticPaymentMethodsSetupIntent>,
    ...
    pub last_setup_error: Option<Box<stripe_types::ApiErrors>>,
    /// The most recent SetupAttempt for this SetupIntent.
    pub latest_attempt:
        Option<stripe_types::Expandable<stripe_types::PaymentFlowsSetupIntentSetupAttempt>>,
    /// Has the value `true` if the object exists in live mode or the value `false` if the object exists in test mode.
    pub livemode: bool,
    /// ID of the multi use Mandate generated by the SetupIntent.
    pub mandate: Option<stripe_types::Expandable<stripe_types::Mandate>>,
    /// Set of [key-value pairs](https://stripe.com/docs/api/metadata) that you can attach to an object.
    ///
    /// This can be useful for storing additional information about the object in a structured format.
    pub metadata: Option<std::collections::HashMap<String, String>>,
    /// If present, this property tells you what actions you need to take in order for your customer to continue payment setup.
    pub next_action: Option<stripe_types::SetupIntentNextAction>,
    ...
    pub payment_method_options: Option<stripe_types::SetupIntentPaymentMethodOptions>,
    /// The list of payment method types (e.g.
    ///
    /// card) that this SetupIntent is allowed to set up.
    pub payment_method_types: Vec<String>,
    /// ID of the single_use Mandate generated by the SetupIntent.
    pub single_use_mandate: Option<stripe_types::Expandable<stripe_types::Mandate>>,
