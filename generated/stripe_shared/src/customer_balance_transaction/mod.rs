...
pub struct CustomerBalanceTransaction {
    ...
    pub id: stripe_shared::customer_balance_transaction::CustomerBalanceTransactionId,
...
impl stripe_types::Object for CustomerBalanceTransaction {
    type Id = stripe_shared::customer_balance_transaction::CustomerBalanceTransactionId;
    fn id(&self) -> &Self::Id {
        &self.id
    }
}
