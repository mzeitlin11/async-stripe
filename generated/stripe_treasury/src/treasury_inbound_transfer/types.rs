    ...
    impl MapBuilder for TreasuryInboundTransferBuilder {
        ...
        fn key(&mut self, k: &str) -> miniserde::Result<&mut dyn Visitor> {
            ...
            match k {
                ...
                "failure_details" => Ok(Deserialize::begin(&mut self.failure_details)),
                ...
                "origin_payment_method" => Ok(Deserialize::begin(&mut self.origin_payment_method)),
                "origin_payment_method_details" => Ok(Deserialize::begin(&mut self.origin_payment_method_details)),
                "returned" => Ok(Deserialize::begin(&mut self.returned)),
