...
pub struct TreasuryOutboundPaymentBuilder {
    ...
    destination_payment_method_details: Option<Option<stripe_treasury::OutboundPaymentsPaymentMethodDetails>>,
    ...
    returned_details: Option<Option<stripe_treasury::TreasuryOutboundPaymentsResourceReturnedStatus>>,
    statement_descriptor: Option<String>,
    status: Option<stripe_treasury::TreasuryOutboundPaymentStatus>,
    status_transitions: Option<stripe_treasury::TreasuryOutboundPaymentsResourceOutboundPaymentResourceStatusTransitions>,
...
const _: () = {
    ...
    impl Visitor for Place<TreasuryOutboundPayment> {
        fn map(&mut self) -> Result<Box<dyn Map + '_>> {
            Ok(Box::new(Builder { out: &mut self.out, builder: TreasuryOutboundPaymentBuilder::deser_default() }))
        }
    }
    ...
    impl MapBuilder for TreasuryOutboundPaymentBuilder {
        ...
        fn key(&mut self, k: &str) -> miniserde::Result<&mut dyn Visitor> {
            match k {
                ...
                "end_user_details" => Ok(Deserialize::begin(&mut self.end_user_details)),
        ...
        fn take_out(&mut self) -> Option<Self::Out> {
            ...
            let end_user_details = self.end_user_details.take()?;
