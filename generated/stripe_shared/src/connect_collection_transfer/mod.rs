...
pub struct ConnectCollectionTransfer {
    ...
    pub id: stripe_shared::connect_collection_transfer::ConnectCollectionTransferId,
    /// Has the value `true` if the object exists in live mode or the value `false` if the object exists in test mode.
    pub livemode: bool,
}
impl stripe_types::Object for ConnectCollectionTransfer {
    type Id = stripe_shared::connect_collection_transfer::ConnectCollectionTransferId;
