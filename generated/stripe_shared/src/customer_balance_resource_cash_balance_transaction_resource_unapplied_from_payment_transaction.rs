...
const _: () = {
    ...
    impl Deserialize for CustomerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransaction {
    ...
    impl Visitor for Place<CustomerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransaction> {
        fn map(&mut self) -> Result<Box<dyn Map + '_>> {
            Ok(Box::new(Builder { out: &mut self.out, builder: CustomerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransactionBuilder::deser_default() }))
        }
    }
    ...
    impl ObjectDeser for CustomerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransaction {
        type Builder = CustomerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransactionBuilder;
    }
};
