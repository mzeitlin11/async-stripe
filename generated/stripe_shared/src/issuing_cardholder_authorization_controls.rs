...
pub struct IssuingCardholderAuthorizationControlsBuilder {
    allowed_categories: Option<Option<Vec<IssuingCardholderAuthorizationControlsAllowedCategories>>>,
    blocked_categories: Option<Option<Vec<IssuingCardholderAuthorizationControlsBlockedCategories>>>,
...
const _: () = {
    ...
    impl Deserialize for IssuingCardholderAuthorizationControls {
    ...
    struct Builder<'a> {
        out: &'a mut Option<IssuingCardholderAuthorizationControls>,
        builder: IssuingCardholderAuthorizationControlsBuilder,
    }

    impl Visitor for Place<IssuingCardholderAuthorizationControls> {
        fn map(&mut self) -> Result<Box<dyn Map + '_>> {
            Ok(Box::new(Builder { out: &mut self.out, builder: IssuingCardholderAuthorizationControlsBuilder::deser_default() }))
        }
    }
...
impl std::fmt::Debug for IssuingCardholderAuthorizationControlsAllowedCategories {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}
impl serde::Serialize for IssuingCardholderAuthorizationControlsAllowedCategories {
...
#[cfg(feature = "min-ser")]
impl miniserde::de::Visitor for crate::Place<IssuingCardholderAuthorizationControlsAllowedCategories> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(IssuingCardholderAuthorizationControlsAllowedCategories::from_str(s).unwrap_or(IssuingCardholderAuthorizationControlsAllowedCategories::Unknown));
        Ok(())
    }
}
/// Array of strings containing [categories](https://stripe.com/docs/api#issuing_authorization_object-merchant_data-category) of authorizations to decline.
...
impl std::fmt::Debug for IssuingCardholderAuthorizationControlsBlockedCategories {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        f.write_str(self.as_str())
    }
}
impl serde::Serialize for IssuingCardholderAuthorizationControlsBlockedCategories {
    fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
    where
        S: serde::Serializer,
    {
...
#[cfg(feature = "min-ser")]
impl miniserde::de::Visitor for crate::Place<IssuingCardholderAuthorizationControlsBlockedCategories> {
    fn string(&mut self, s: &str) -> miniserde::Result<()> {
        use std::str::FromStr;
        self.out = Some(IssuingCardholderAuthorizationControlsBlockedCategories::from_str(s).unwrap_or(IssuingCardholderAuthorizationControlsBlockedCategories::Unknown));
        Ok(())
    }
}
