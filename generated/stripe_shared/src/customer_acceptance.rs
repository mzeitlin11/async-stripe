...
const _: () = {
    ...
    impl Visitor for Place<CustomerAcceptance> {
        fn map(&mut self) -> Result<Box<dyn Map + '_>> {
            Ok(Box::new(Builder { out: &mut self.out, builder: CustomerAcceptanceBuilder::deser_default() }))
        }
    }
    ...
    impl MapBuilder for CustomerAcceptanceBuilder {
        ...
        fn key(&mut self, k: &str) -> miniserde::Result<&mut dyn Visitor> {
            ...
            match k {
                ...
                "online" => Ok(Deserialize::begin(&mut self.online)),
        ...
        fn deser_default() -> Self {
            Self { accepted_at: Deserialize::default(), offline: Deserialize::default(), online: Deserialize::default(), type_: Deserialize::default() }
        }
