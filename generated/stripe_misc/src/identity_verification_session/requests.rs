...
impl AsRef<str> for CreateIdentityVerificationSessionOptionsDocumentAllowedTypes {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl AsRef<str> for UpdateIdentityVerificationSessionOptionsDocumentAllowedTypes {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
