...
pub struct CreateProduct<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub features: Option<&'a [CreateProductFeatures<'a>]>,
...
/// These are displayed in [pricing tables](https://stripe.com/docs/payments/checkout/pricing-table).
#[derive(Copy, Clone, Debug, serde::Serialize)]
pub struct CreateProductFeatures<'a> {
    /// The feature's name.
    ///
    /// Up to 80 characters long.
    pub name: &'a str,
}
impl<'a> CreateProductFeatures<'a> {
    pub fn new(name: &'a str) -> Self {
        Self { name }
    }
}
...
pub struct UpdateProduct<'a> {
    ...
    /// These are displayed in [pricing tables](https://stripe.com/docs/payments/checkout/pricing-table).
    #[serde(skip_serializing_if = "Option::is_none")]
    pub features: Option<&'a [UpdateProductFeatures<'a>]>,
    /// A list of up to 8 URLs of images for this product, meant to be displayable to the customer.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub images: Option<&'a [&'a str]>,
    /// Set of [key-value pairs](https://stripe.com/docs/api/metadata) that you can attach to an object.
...
/// These are displayed in [pricing tables](https://stripe.com/docs/payments/checkout/pricing-table).
#[derive(Copy, Clone, Debug, serde::Serialize)]
pub struct UpdateProductFeatures<'a> {
    /// The feature's name.
    ///
    /// Up to 80 characters long.
    pub name: &'a str,
}
impl<'a> UpdateProductFeatures<'a> {
    pub fn new(name: &'a str) -> Self {
        Self { name }
    }
}
...
impl<'a> ListProduct<'a> {
    ...
    pub fn paginate(self) -> stripe::ListPaginator<stripe_types::Product> {
