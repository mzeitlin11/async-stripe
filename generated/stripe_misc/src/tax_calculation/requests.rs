...
impl AsRef<str> for CreateTaxCalculationCustomerDetailsAddressSource {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl AsRef<str> for CreateTaxCalculationCustomerDetailsTaxIdsType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl AsRef<str> for CreateTaxCalculationCustomerDetailsTaxabilityOverride {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl AsRef<str> for CreateTaxCalculationLineItemsTaxBehavior {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl AsRef<str> for CreateTaxCalculationShippingCostTaxBehavior {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
