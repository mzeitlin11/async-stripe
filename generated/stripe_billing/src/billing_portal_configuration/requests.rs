...
impl AsRef<str> for CreateBillingPortalConfigurationFeaturesSubscriptionCancelCancellationReasonOptions {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl AsRef<str> for CreateBillingPortalConfigurationFeaturesSubscriptionUpdateDefaultAllowedUpdates {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl AsRef<str> for UpdateBillingPortalConfigurationFeaturesSubscriptionCancelCancellationReasonOptions {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl AsRef<str> for UpdateBillingPortalConfigurationFeaturesSubscriptionUpdateDefaultAllowedUpdates {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
